...
extension UIFont {
    ...
    @nonobjc static let CIStatsInfoLabelFont = UIFont(name: "Oswald-Light", size: 18.0)!
    @nonobjc static let CIStatsDataLabelFont = UIFont(name: "Oswald-Regular", size: 32.0)!
